  ...
  return (
    <header>
      <div id="header-app">
        ...
        <div id="header-text">
          Eyes Talk은 화상 회의를 통해 실시간으로 소통이 가능합니다.
          <br></br>
          <br></br>관심사에 맞는 회의방을 만들어 소통해보세요!
        </div>
        <button onClick={openModal} id="start-button">
          회의 시작
        </button>
        <Modal open={modalOpen} close={closeModal} header="방 만들기"></Modal>
      </div>
    </header>
  );
};
  ...
  return (
    <>
      <div id="middle-box">
        ...
        <div id="all-btn-div">
          <button id="all-btn" onClick={viewAll}>
            전체보기
          </button>
        </div>
      </div>
      ...
      <footer id="first-footer">
        <div id="desc-all">
          ...
          <div className="desc-box">
            <div className="desc-name">노희재</div>
            <div className="desc-mail">rhj0830@gmail.com</div>
          </div>
          <div className="desc-box">
            <div className="desc-name">김남주</div>
            <div className="desc-mail">jupitern404@gmail.com</div>
          </div>
          <div className="desc-box">
            <div className="desc-name">이현지</div>
            <div className="desc-mail">dleeh197@gmail.com</div>
          </div>
          <div className="desc-box">
            <div className="desc-name">이기빈</div>
            <div className="desc-mail">lkb980316@gmail.com</div>
          </div>
        </div>
        <div id="logo-box">
