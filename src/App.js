  ...
  return <header>
    <div id="header-app">
      ...
      <Modal open={modalOpen} close={closeModal} header="방 만들기">
        ...
        <div><input className="modal-input" placeholder='방 제목을 입력주세요'></input></div>
        <div className='modal-text'>수용 인원</div>
        <div><input className="modal-input" placeholder='수용 인원을 입력해주세요'></input></div>
        <div className='modal-text'>비밀번호</div>
        <div><input className="modal-input" placeholder='비밀번호를 입력해주세요'></input></div>
      </Modal>
    </div>
  </header>
}
